...
public class BaseNanoLabMethods extends BaseTestMethods
{
	...
	/*
	 * This method launches the AUT caNanoLab website 	
	 */
	...
	public void click_next_result_page_link_until(String gLinkVal) throws TestExecutionException{
		...
		for (int i=1;i<rCount;i++){
			...
			if (utilVal == true){
				...
				boolean boolNLink1 = isDisplayed(By.linkText("»"));
				boolean boolNLink2 = isEnabled(By.linkText("»"));
	...
	public void login(String uname, String pword, String expRes) throws TestExecutionException {
		...
		if (uname == "curatorUserName" && pword == "curatorPassword"){
			...
			//Do nothing
			//logger.error("Please ensure a valid sets of Curator and Researcher Credential in the User Credential notepad file");
		}
	...
	public void logout () throws TestExecutionException {
		...
		String text = getText(By.xpath("//table/tbody/tr/td[2]/table/tbody/tr[2]/td/b"));

		boolean retVal = verifyText(text,"No account is required to browse publicly available data.");
		if (retVal == true){
	...
	public void accessToThe(String accessUsrID, String accessUsrInfo) throws TestExecutionException {
		...
		wait_For(2000);
		choseAccessPublication("READ WRITE DELETE");
	...
	public void navigate_to_sample_search_from_Home_page() throws TestExecutionException {
		...
		click(By.cssSelector(".alt .gridtableNoBorder tbody tr td:nth-child(2) a"));
		wait_For(4000);
	}
	/*
	 * 
	...
	public void remove_my_favorites_publication_all() throws TestExecutionException {
		...
		if (getMyFavRetVal == true){
			...
			if (getTabVal == true){
				for (int i=2;i<=rCount;i++){
					String actionText = getText(By.cssSelector(".table.publication.ng-scope tbody tr:nth-child("+ i +") td:nth-child(1)"));
					if (actionText.contains("View") && actionText.contains("Edit"))
						...
						clickLink(By.cssSelector(".table.publication.ng-scope tbody tr:nth-child("+ i +") td:nth-child(1) a:nth-child(3)"));
					else
						clickLink(By.cssSelector(".table.publication.ng-scope tbody tr:nth-child("+ i +") td:nth-child(1) a:nth-child(2)"));
					checkAlertOK();
					wait_For(5000);
				}
			}
	...
	public void publication_add_to_favorites(String getPublicationNameVal, String getMyFavVerificationYesOrNo, String getViewOrEditOrRemove) throws TestExecutionException {
		...
		for (int i=1;i<=rCount;i++){
			...
			if (part1.toLowerCase().contains(getPublicationNameVal.toLowerCase())){
				String actions = getText(By.cssSelector(".table.sample.ng-scope.ng-table tbody tr:nth-child("+ i +") td:nth-child(1)"));
				if (actions.contains("Edit"))
					clickLink(By.cssSelector(".table.sample.ng-scope.ng-table tbody tr:nth-child("+ i +") td:nth-child(1) a:nth-child(3)"));
				else
					clickLink(By.cssSelector(".table.sample.ng-scope.ng-table tbody tr:nth-child("+ i +") td:nth-child(1) a:nth-child(2)"));
				...
				logger.info("=========================================================================");
				String getBuildString = "Edit "+ part1 +" has already been added to your favorites"; 
				//logger.info("getBuildString:["+getBuildString);
				String getSccssConfVal = "Added to Favorites"; 
				...
				if (getFavStatusVal.contains(getSccssConfVal)){
	...
	public void verify_publication_edit_val(String getPublicationNameEditVal) throws TestExecutionException {
		...
		logger.info("getPublicationNameEditVal:["+getPublicationNameEditVal + "***");
		if (getPublicationNameVal.toLowerCase().equals(getPublicationNameEditVal.toLowerCase())){
	...
	public void verify_publication_add_to_favorites(String getPublicationNameSearchVal) throws TestExecutionException {
		...
		for (int i=1;i<=rVCount;i++){
			...
			if (part1a.equals(getPublicationNameSearchVal)){
				...
				String getSuccessConfVal = "Added to Favorites"; 
				if (getAddtoFavStatusVal.contains(getSuccessConfVal)){
					logger.info("Publication has been added to the My Favorites successfully");
	...
	public void protocol_add_to_favorites(String getProtocolNameVal, String getMyFavVerificationYesOrNo, String getViewOrEditOrRemove) throws TestExecutionException {
		...
		for (int i=1;i<rCount;i++){
			...
			if (protocolTableCellData.toLowerCase().contains(getProtocolNameVal.toLowerCase())){
				...
				getFavStatusVal = getText(By.cssSelector(".table.sample.ng-scope.ng-table tbody tr:nth-child("+ i +") td:nth-child(1)")).replaceAll("\\n", " ");
	...
	public void samples_search_simple (String keyword, String SampleNameDropDown, String SampleName, String SamplePointofDropDown, String SamplePointof, String NanomaterialEntity, String FunctionalizingEntity, String Function, String CharacterizationType, String Characterization, String SearchOrReset) throws TestExecutionException {
		...
		boolean retVal2 = verifyElementIsTrueOrFalse(By.id("keywordsearch")); // Keyword Text Box
		...
		if (gkeyword == false){
			enter(By.id("keywordsearch"),keyword);
		}
		...
		for (int i=1;i<rCount;i++){
			...
			for (int r=1;r<resRowCount;r++){
				...
				if (getVal == true){
					...
					boolean boolNLink1 = isDisplayed(By.xpath("//a[contains(text(),'�')]"));
					boolean boolNLink2 = isEnabled(By.xpath("//a[contains(text(),'�')]"));
	...
	public void verifyUrl(String expectedUrl) throws TestExecutionException {
		...
		boolean retVal = true;
		try{
			Assert.assertTrue(actualUrl.toLowerCase().startsWith(expectedUrl.toLowerCase()));	
	...
	public void Verify_the_ability_to_submit_a_New_Publication(String pbType, String pbStatus, String pubTitle, String smpNam, String accessUsrID, String accessUsrInfo) throws TestExecutionException {
		...
		boolean retVal5 = isTextPresent("READ WRITE DELETE");
